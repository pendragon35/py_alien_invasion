...
def get_number_aliens_x(ai_settings, alien_width):
    ...
    number_aliens_x = int(avaliable_aliens_x / (2 * alien_width))
...
def check_aliens_bottom(ai_settings, screen, aliens, stats, ship, bullets):
    screen_rect = screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ship_hit(ai_settings, screen, aliens, stats, ship, bullets)
            break
...
def check_events(ai_settings, ship, screen, bullets, play_button, stats, aliens):
